...
python3 dstest --iter 500 --race --workers 10 --timeout 30 --output out.log TestConcurrent1 
# python3 dstest --iter 5000 --workers 10 --timeout 15 --output out.log TestConcurrentUnreliable